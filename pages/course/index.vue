          ...
          <section class="fl">
            ...
            <ol class="js-tap clearfix">
              ...
              <li :class="{'current bg-green': $route.query.priceSort}">
                <!-- 默认升序 -->
                <a v-if="!$route.query.priceSort || $route.query.priceSort == 1" title="价格" href="javascript:void(0);" @click="searchPrice(2)">价格
                  <i>↑</i>
                </a>

                <a v-if="$route.query.priceSort == 2" title="价格" href="javascript:void(0);" @click="searchPrice(1)">价格
                  <i>↓</i>
                </a>
              </li>
            </ol>
...
export default {
  ...
  async asyncData(page) { // 此处传递当前页面的上下文对象，以便获取查询条件
    ...
    searchObj.priceSort = query.priceSort || '' // 1：正序，2：倒序
